const questionsData = [
    { q: "Самая высокая гора в мире?", options: ["Эверест", "Килиманджаро", "Монблан"], answer: "Эверест" },
    { q: "Какая река самая длинная в мире?", options: ["Амазонка", "Нил", "Миссисипи"], answer: "Нил" },
    { q: "Столица Франции?", options: ["Берлин", "Париж", "Рим"], answer: "Париж" },
    { q: "Какой океан самый большой?", options: ["Атлантический", "Тихий", "Индийский"], answer: "Тихий" },
    { q: "Какая страна самая большая по площади?", options: ["Россия", "Канада", "Китай"], answer: "Россия" },
    { q: "Самый большой материк?", options: ["Евразия", "Африка", "Антарктида"], answer: "Евразия" },
    { q: "Самая большая пустыня на Земле?", options: ["Сахара", "Гоби", "Калахари"], answer: "Сахара" },
    { q: "Какая страна находится на двух континентах?", options: ["Турция", "Италия", "Испания"], answer: "Турция" },
    { q: "Какая река протекает через Египет?", options: ["Нил", "Конго", "Замбези"], answer: "Нил" },
    { q: "Столица Японии?", options: ["Сеул", "Токио", "Пекин"], answer: "Токио" },
    { q: "Какая страна самая густонаселённая?", options: ["Индия", "Китай", "США"], answer: "Китай" },
    { q: "Самое глубокое озеро в мире?", options: ["Байкал", "Виктория", "Титикака"], answer: "Байкал" },
    { q: "Столица Австралии?", options: ["Сидней", "Мельбурн", "Канберра"], answer: "Канберра" },
    { q: "Какая гора является символом Японии?", options: ["Фудзи", "Килиманджаро", "Эверест"], answer: "Фудзи" },
    { q: "Какой океан омывает берега Африки с востока?", options: ["Атлантический", "Индийский", "Тихий"], answer: "Индийский" },
    { q: "Самая маленькая страна по площади?", options: ["Ватикан", "Монако", "Сан-Марино"], answer: "Ватикан" },
    { q: "Какая страна известна как страна тысячи озёр?", options: ["Финляндия", "Канада", "Россия"], answer: "Финляндия" },
    { q: "Самый длинный каньон в мире?", options: ["Гранд-Каньон", "Тара", "Колка"], answer: "Гранд-Каньон" },
    { q: "Какая страна имеет форму сапога?", options: ["Италия", "Греция", "Испания"], answer: "Италия" },
    { q: "Столица Канады?", options: ["Торонто", "Оттава", "Ванкувер"], answer: "Оттава" }
];
